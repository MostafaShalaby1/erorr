...
async def start(_, message: Message):
        ...
        f"""**مرحبا, انا {bn} 🎀
**يسمح لك بتشغيل الموسيقى والفيديو في مجموعات من خلال محادثات الفيديو الجديدة في التلي**
⋆ **قم بإضافة البوت اللي مجموعتك لكي تبدا الحفله..😺♥️** [𝐃𝐞𝐂𝐨𝐝𝐞-𝐃𝐞𝐯𝐬](https://t.me/vod_ika0).
        """,
